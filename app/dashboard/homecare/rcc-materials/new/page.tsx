...
import { NewOrderForm } from "@/components/rcc-new-order-form";

export default async function NewRccMaterialOrderPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-4 py-8">
      ...
      <div className="relative z-10 mx-auto max-w-md">
        ...
        <NewOrderForm materials={materials ?? []} userId={user.id} />
      </div>
    </main>
  );
}
